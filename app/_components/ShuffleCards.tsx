...
const items: StackableItem[] = [
  { id: 1,  img: "https://cdn.prod.website-files.com/682310547ba9eeb97324a89e/6824aadd04f4257c5f7f85fc_event-image-5.avif", rotation: "-3deg" },
  { id: 2, img: "https://cdn.prod.website-files.com/682310547ba9eeb97324a89e/6824aaddd92bb1ada35b5840_event-image-2.avif", rotation: "3deg" },
  { id: 3, img: "https://cdn.prod.website-files.com/682310547ba9eeb97324a89e/6824aadd1a93d98874d5b679_event-image-3.avif", rotation: "-3deg"},
  { id: 4, img: "https://cdn.prod.website-files.com/682310547ba9eeb97324a89e/6824aaddb9d81bad24595e36_event-image-4.avif", rotation: "3deg"},
  { id: 5,img:"https://cdn.prod.website-files.com/682310547ba9eeb97324a89e/6824aaddd793e76751328121_event-image-1.avif", rotation: "3deg"},
];


const [cards, setCards] = useState([...items]);
  const [shuffleDirection, setShuffleDirection] = useState<'left' | 'right'>('right');
...
>
  <div className="h-[16.975px] w-[16.975px]">
    <svg
      ...
      viewBox="0 0 24 24"
      fill="none"
      className="h-[16.975px] w-[16.975px]"
    >
      <path d="M1 4V10H7" stroke="currentColor" strokeWidth="2.5" />
      <path d="M23 20V14H17" stroke="currentColor" strokeWidth="2.5" />
      <path d="M20.5 8.99998C19.6855 6.75968 18.0244 4.92842 15.8739 3.89992C13.7235 2.87143 11.2553 2.72782 9 3.49998C7.7459 3.98238 6.59283 4.69457 5.6 5.59998L1 9.99998M23 14L18.4 18.4C16.6963 20.0855 14.3965 21.0308 12 21.0308C9.60347 21.0308 7.30368 20.0855 5.6 18.4C4.69459 17.4072 3.9824 16.2541 3.5 15"
        stroke="currentColor"
        strokeWidth="2.5"
      />
    </svg>
  </div>
  <span className="text-[16.9778px]">Shuffle</span>
</button>
