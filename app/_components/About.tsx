...
`;
  ...
  const renderHalfCircle = (itemsToRender: any[], side: string) => {
    return itemsToRender.map((item: { id: React.Key | null | undefined; borderColor: any; image: string | Blob | undefined; name: string | undefined; }, index: number) => {
      const angle = (index / itemsToRender.length) * 160;
      const radius = 300;
      ...
      return (
        ...
        >
          <div
            className={`rounded-lg shadow-xl w-[144px] h-[146px] flex items-center justify-center hover:shadow-2xl transition-shadow bg-white border-[1.6px] ${item.borderColor}`}
          >
                       {" "}
            <img
              src={item.image}
              alt={item.name}
              className="w-[144px] h-[144px] object-cover rounded-lg"
            />
                     {" "}
          </div>
        </div>
...
const sponsorContent = (
  <>
    {/* dot */}
    <div className="h-[40px] w-[40px] flex-shrink-0 flex items-center justify-center">
    ...
    {/* Osmos logo */}
    <div className="w-[128.387px] h-[28.65px] flex-shrink-0 cursor-pointer">
  ...
  return (
    <>
      <div className="overflow-hidden">
        <style>{styles}</style>
        <div className="pt-[178px] w-[120%] ">
          <div className="relative h-[98.6625px] w- bg-[#F3A20F] text-white text-[31.8333px] font-heading-bold border-t-[1.6px] border-b-[1.6px] border-black shadow-[0px_6px_0px_0px] shadow-[rgb(0,0,0,0.2)] overflow-hidden">
            <div className="animate-slide flex items-center  gap-[47.75px] h-full whitespace-nowrap">
              {sponsorContent}
              {sponsorContent}
              {sponsorContent}
              {sponsorContent}
      ...
      <div
        ref={containerRef}
        className="h-[] bg-black pt-[153px] pb-[180px] px-[67px]"
      >
        <div
          className="flex items-center bg-[#3185f5] w-[125.688px] pl-[6.36667px] rounded-t-[2px] pt-[4.24444px] pb-[2px]  z-[]"
          style={{
            fontFamily: 'Arial, "Helvetica Neue", Helvetica, sans-serif',
          }}
        >
          <svg
            className="h-[11.6722px] w-[11.6722px] flex-shrink-0"
          ...
          <span className="ml-[4.24444px]  text-[11.6722px] leading-[11.6722px]">
            What is FlowFest?
          </span>
        </div>

        <div className="h-[509px]  relative w-[1392px] border-[#3185f5] justify-between flex border-[2px] overflow-hidden">
          <div className="w-[250px] ">
            <div
              className="absolute left-[-250px] top-0 h-full w-[250px] pointer-events-none"
          ...
          <div>
            <div className="pt-[101px] font-heading-bold text-[68.9722px] text-center leading-none">
              <h2 className="m-0 p-0 leading-none">The No.1 Fest for:</h2>

              <div className="bg-[#F3A20F] w-[634px] h-[75.2625px] border-[1.6px] border-black text-nowrap font-heading-bold text-[65.5236px] rounded-md px-[16.3809px] rotate-[-1deg] shadow-[0px_6px_0px_0px] shadow-[#353535] mx-auto flex items-center justify-center">
                <h2 className="m-0 p-0 leading-none">Web Designers & Devs</h2>
              </div>
            </div>

            <div className="pt-[31px] w-[424px]  mx-auto text-center text-[16.9778px] leading-[22.0711px] font-[500]">
              {" "}
              <p>
...
              onClick={() => togglePopup(true)}
              className=" hover:translate-y-[4px] transition-transform duration-200 cursor-pointer flex items-center  mt-[33px] mx-auto w-[250px] h-[51px] rounded-[30px] bg-[#FFFEFB] px-[22px]"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 28 28"
                className="w-[20px] h-[20px] mb-[-1px] flex-shrink-0"
                fill="#F489A3"
                stroke="black"
                strokeWidth="2.5"
                strokeMiterlimit="10"
              ...
              <p className="text-nowrap text-black text-[16.9778px] m-0">
            ...
            {isOpen && (
              ...
              >
                ...
                >
                  <div
                    className={`video-frame  flex items-center justify-center w-full h-full ${
                      isClosing ? "closing" : ""
                    }`}
                    style={{
                      padding: "67px 254px",
          ...
          <div className="w-[250px] ">
            <div
              className="absolute right-[-250px] top-0 h-full w-[250px] pointer-events-none"
              style={{ perspective: "1000px" }}
            >
              <div
                className="absolute inset-0"
