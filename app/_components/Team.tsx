...
function Team() {
  ...
  return (
    <>
      <div className="px-[13.12px] overflow-hidden md:px-[42.2px] lg:px-[45.51px] xl:px-[64px] 2xl:px-[68px] mt-[-34px] rounded-bl-[60px] rounded-br-[60px] text-black mb-[-60px] relative bg-[#F3ECD2]">
